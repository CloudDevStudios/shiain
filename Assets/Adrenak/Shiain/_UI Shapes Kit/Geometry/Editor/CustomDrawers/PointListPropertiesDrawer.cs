...
using PointListProperties = Adrenak.Shiain.UIShapesKit.PointsList.PointListProperties;
using PointListGeneratorData = Adrenak.Shiain.UIShapesKit.PointsList.PointListGeneratorData;
...
public class PointListPropertiesDrawer : PropertyDrawer
{
	...
	{
		var polygon = property.serializedObject.targetObject as Adrenak.Shiain.UIShapesKit.Polygon;
