...
using ShadowsProperties = Adrenak.Shiain.UIShapesKit.GeoUtils.ShadowsProperties;
using ShadowProperties = Adrenak.Shiain.UIShapesKit.GeoUtils.ShadowProperties;
